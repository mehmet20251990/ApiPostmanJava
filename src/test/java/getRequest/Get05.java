...
public class Get05 extends TheMovieDBBaseURL {
    ...
    public void get05(){
       ...
       */
        ...
        Response response = given().spec(specification).when().get("/{moviePath}/{popularPath}"); // get metodumun içerisine
                                                        // çalışacğaım endpoşntleri sytanx ıne uygun bir şekilde yazmalıyım.
